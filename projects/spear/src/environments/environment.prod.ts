...
export const environment = {
  ...
  site: 'bloodhound',
  apiGatewaySettings: {
    endpointUrl: 'https://edge.hedge.earth/octostore/rollthecloudinc/bloodhound-objects-prod/shapeshifter',
  },
  mediaSettings: {
    endpointUrl: 'https://edge.hedge.earth/octorestore/media',
    cloudinaryUrl: 'https://api.cloudinary.com/v1_1/dj4vvkgzw',
    uploadPreset: 'i0hm4opm',
    imageUrl: 'https://edge.hedge.earth/octostore/bloodhound',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/bloodhound-objects-prod'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-prod-o5unofrr3c4qb3ykfrxebh2e4a'
  },
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://bloodhound.carbonfreed.app/auth-callback',
    silent_redirect_uri: 'https://bloodhound.carbonfreed.app/silent-refresh.html',
    response_type: "code",
